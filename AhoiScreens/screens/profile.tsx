...
// Bottom Tab Icons
const HomeIcon = ({ color = '#c7cad1' }: { color?: string }) => (
...
const PlusIcon = ({ color = '#c7cad1' }: { color?: string }) => (
  <Svg width={21} height={21} viewBox="0 0 24 24" fill="none">
    <Path
      d="M12 5v14"
      stroke={color}
...
const CreditCardIcon = ({ color = '#c7cad1' }: { color?: string }) => (
  <Svg width={21} height={21} viewBox="0 0 24 24" fill="none">
    <Path
      d="M1 4h22v16H1z"
      stroke={color}
    ...
    <SafeAreaView style={styles.container}>
      ...
      <View style={styles.bottomNav}>
        <TouchableOpacity 
          ...
          onPress={() => handleNavigation('HomeFilled')}
        >
          <HomeIcon />
        ...
        <TouchableOpacity 
          style={styles.navItem}
          onPress={() => handleNavigation('AllRequests')}
        >
          <PlusIcon />
...
const styles = StyleSheet.create({
  ...
  activeNavItem: {
    // Profile is active, no additional styling needed as it's already highlighted
  },
  navText: {
    fontSize: 15,
    fontWeight: '500',
